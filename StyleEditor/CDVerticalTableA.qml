  ...
  Component {
    ...
    Item {
      ...
      Item {
        ...
        ListModel {
            id: textModel
            ListElement { text: "BG - properties"}
            ListElement { text: "TEXT - properties"}
            ListElement { text: "BORDER - properties" }
        }
      ...
      Item {
        ...
        GridView {
          ...
          Slider {
              ...
              onValueChanged: {
                  mainText.font.pixelSize = control.value
              }
          ...
          ColorDialog {
              ...
              title: "Please choose a color"
              onAccepted: {
                  mainText.color = colorDialogText.color
          ...
          Slider {
              ...
              handle: Rectangle {
                  x: controlBorderMinor.leftPadding + controlBorderMinor.visualPosition * (controlBorderMinor.availableWidth - width)
                  y: controlBorderMinor.topPadding + controlBorderMinor.availableHeight / 2 - height / 2
                  implicitWidth: 26
                  implicitHeight: 26
                  radius: 13
                  color: control.pressed ? "#f0f0f0" : "#f6f6f6"
                  ...
                  Label {
                      anchors.centerIn: parent
                      text: Number(controlBorderMinor.value).toFixed()
                  }
              }
              ...
              onValueChanged: {
                minorRectangle.border.width = controlBorderMinor.value
              }

              background: Rectangle {
                  x: controlBorderMinor.leftPadding
                  y: controlBorderMinor.topPadding + controlBorderMinor.availableHeight / 2 - height / 2
                  implicitHeight: 4
                  width: controlBorderMinor.availableWidth
                  height: implicitHeight
                  radius: 13
                  color: "#868A01"
              }
      ...
      states: State {
        ...
        PropertyChanges {
          ...
          x: 0
          height: {
            return detailsGrid.contentHeight + iDelHeight + 25 + 180
          }
        }
        PropertyChanges {
          target: detailsGrid;
